...
namespace DigitPark.Animations
{
    ...
    public class WinCelebrationAnimator : MonoBehaviour
    {
        ...
        private IEnumerator WinSequence(Transform resultIconTransform)
        {
            ...
            var fadeOut = flashImage.DOFade(0f, 0.4f).SetEase(Ease.OutQuad);
            TrackTween(fadeOut);
            ...
            if (resultIconTransform != null)
            {
                ...
                popIn.Append(resultIconTransform.DOScale(1.3f, 0.3f).SetEase(Ease.OutBack, 3f));
                popIn.Append(resultIconTransform.DOScale(1f, 0.15f).SetEase(Ease.InOutQuad));
                TrackTween(popIn);
            }
        ...
        private IEnumerator LoseSequence()
        {
            ...
            var fadeOut = flashImage.DOFade(0f, 0.5f).SetEase(Ease.OutQuad);
            TrackTween(fadeOut);
        ...
        private IEnumerator NewHighScoreSequence()
        {
            ...
            seq.Join(textRT.DOScale(1.3f, 0.25f).SetEase(Ease.OutBack, 3f));
            ...
            ringSeq.Append(ringRT.DOScale(12f, 0.5f).SetEase(Ease.OutQuad));

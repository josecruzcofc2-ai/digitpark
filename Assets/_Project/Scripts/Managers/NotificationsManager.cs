...
namespace DigitPark.Managers
{
    ...
    public class NotificationsManager : MonoBehaviour
    {
        ...
        private void LoadNotifications()
        {
            ...
            if (NotificationStorageService.Instance == null)
            {
                ShowEmpty("Servicio no disponible");
                return;
            }
        ...
        private void SetupNotificationCard(GameObject card, StoredNotification notification)
        {
            ...
            if (typeIcon != null)
            {
                typeIcon.text = GetTypeIcon(notification.type);
                typeIcon.color = GetTypeColor(notification.type);
            }
        ...
        private void SetupCardActions(GameObject card, StoredNotification notification)
        {
            ...
            {
                case "friend_request":
                    SetActionButton(primaryBtn, primaryText, "Aceptar", true);
                    SetActionButton(secondaryBtn, secondaryText, "Rechazar", true);
                ...
                case "friend_accepted":
                    SetActionButton(primaryBtn, primaryText, "Ver perfil", true);
                ...
                case "tournament_start":
                    SetActionButton(primaryBtn, primaryText, "Unirse", true);
                    SetActionButton(secondaryBtn, secondaryText, null, false);
                    primaryBtn?.onClick.AddListener(() => OnJoinTournament(notification.targetId));
                    break;

                case "tournament_result":
                    SetActionButton(primaryBtn, primaryText, "Ver resultados", true);
                    SetActionButton(secondaryBtn, secondaryText, null, false);
                    primaryBtn?.onClick.AddListener(() => OnViewTournamentResults(notification.targetId));
                    break;

                case "daily_reward":
                    SetActionButton(primaryBtn, primaryText, "Reclamar", true);
                    SetActionButton(secondaryBtn, secondaryText, null, false);
                    primaryBtn?.onClick.AddListener(() => OnClaimDailyReward());
                    break;

                case "promo":
                    SetActionButton(primaryBtn, primaryText, "Ver oferta", true);
                    SetActionButton(secondaryBtn, secondaryText, null, false);
        ...
        private string GetEmptyMessage()
        {
            ...
            {
                case NotificationCategory.Social: return "No tienes notificaciones sociales";
                case NotificationCategory.Games: return "No tienes notificaciones de juegos";
                case NotificationCategory.Rewards: return "No tienes notificaciones de recompensas";
                default: return "No tienes notificaciones\nTe avisaremos cuando algo importante suceda";
            }
        }

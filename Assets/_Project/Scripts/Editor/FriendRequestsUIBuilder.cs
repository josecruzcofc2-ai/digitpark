...
namespace DigitPark.Editor
{
    ...
    public class FriendRequestsUIBuilder : EditorWindow
    {
        ...
        [MenuItem("DigitPark/UI Builders/Social/FriendRequests", false, 172)]
        ...
        private static void RebuildFriendRequests()
        {
            ...
            string[] oldNames = {
                "Background", "Header", "TabsBar", "ScrollView",
                "ContentPanel", "RequestsPanel"
            };
        ...
        private static void CreateTabs()
        {
            ...
            CreateTabButton(tabsBar.transform, "ReceivedTab", "Recibidas", true);

            // Sent Tab
            CreateTabButton(tabsBar.transform, "SentTab", "Enviadas", false);
        ...
        private static void CreateRequestItemPrefab()
        {
            ...
            CreateActionButton(buttonsRow.transform, "AcceptButton", "\u2713", GREEN_SUCCESS, TEXT_DARK);

            // Reject Button (for received)
            CreateActionButton(buttonsRow.transform, "RejectButton", "\u2717", RED_REJECT, TEXT_WHITE);

            // Cancel Button (for sent - hidden by default)
            var cancelBtn = CreateActionButton(buttonsRow.transform, "CancelButton", "Cancelar", CARD_BG_LIGHT, ORANGE_CANCEL);

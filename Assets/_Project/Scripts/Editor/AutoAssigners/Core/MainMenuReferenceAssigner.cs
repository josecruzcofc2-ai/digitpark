...
namespace DigitPark.Editor.AutoAssigners
{
    ...
    public class MainMenuReferenceAssigner : EditorWindow
    {
        ...
        [MenuItem("DigitPark/Auto Assigners/References/Core/MainMenu References", false, 221)]
        ...
        private static void AssignAllReferences()
        {
            ...
            // User info
            AssignReference(so, "userButton", FindButtonByName("profilecard", "playercard", "user", "profile"));

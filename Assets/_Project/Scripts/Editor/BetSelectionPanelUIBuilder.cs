    ...
    public class BetSelectionUIBuilder : EditorWindow
    {
        ...
        private static void CreateCurrencyBar(Transform parent)
        {
            ...
            CreateCurrencyColumn("GemsColumn", bar.transform,
                "GEMAS", "GemsLabel", "GemsValueText", GEM_COLOR);
            ...
            CreateCurrencyColumn("CoinsColumn", bar.transform,
                "MONEDAS", "CoinsLabel", "CoinsValueText", COIN_COLOR);
        }
        ...
        private static void CreateCustomBetSection(Transform parent)
        {
            ...
            CreateToggleButton("CustomCoinsToggle", toggleRow.transform, "MONEDAS", COIN_COLOR, true);
            CreateToggleButton("CustomGemsToggle", toggleRow.transform, "GEMAS", GEM_COLOR, false);
        ...
        private static void CreateActionButtons(Transform parent)
        {
            ...
            CreateActionButton("PlayButton", row.transform, "JUGAR", BTN_PLAY, BTN_PLAY_GLOW, true);
            CreateActionButton("CancelButton", row.transform, "CANCELAR", BTN_CANCEL, Color.clear, false);
        }

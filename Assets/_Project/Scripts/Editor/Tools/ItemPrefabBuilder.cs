    ...
    public class ItemPrefabBuilder : EditorWindow
    {
        ...
        private static void CreateTournamentSearchItemPrefab()
        {
            ...
            CreateTextElement(itemObj.transform, "ParticipantsText", "12/50",
                0f, 0.15f, (int)FontSizes.Body, GOLD, FontStyles.Bold);
        ...
        private static void CreateTournamentMyItemPrefab()
        {
            ...
            // Tournament Name
            CreateTextElementAnchored(header.transform, "TournamentName", "Tournament by @Creator",
                new Vector2(0.05f, 0), new Vector2(0.7f, 1), (int)FontSizes.Body, CYAN_NEON, FontStyles.Bold, TextAlignmentOptions.Left);
            ...
            // Botón Jugar
            CreateButton(actions.transform, "PlayButton", "PLAY", CYAN_NEON, Color.black,

...
namespace DigitPark.Editor
{
    ...
    public class AchievementCardStateToggler : EditorWindow
    {
        ...
        [MenuItem("DigitPark/UI Builders/Monetization/Achievements Card State Toggler", false, 186)]
        ...
        private static int ApplyMix(Transform gridTransform)
        {
            ...
            {
                // BEGINNER
                ("Trophy_first_game", "Primer Paso", 0, false, false, false),
                ("Trophy_tutorial_complete", "Aprendiz", 0, false, false, false),
                ("Trophy_first_win", "Primera Victoria", 100, true, false, false),
                ("Trophy_profile_complete", "Identidad", 0, false, false, false),
                // MASTERY
                ("Trophy_digitrush_master", "Maestro de Digitos", 45, false, true, false),
                ("Trophy_flashtap_master", "Reflejos de Luz", 30, false, true, false),
                ("Trophy_memorypairs_master", "Memoria Fotografica", 0, false, false, false),
                ("Trophy_quickmath_master", "Calculadora Humana", 20, false, true, false),
                ("Trophy_oddoneout_master", "Ojo de Aguila", 65, false, true, false),
                // VICTORIES
                ("Trophy_wins_10", "Competidor", 80, false, true, false),
                ("Trophy_wins_50", "Veterano", 40, false, true, false),
                ("Trophy_wins_100", "Centurion", 15, false, true, false),
                ("Trophy_wins_500", "Leyenda", 5, false, true, false),
                ("Trophy_wins_1000", "Inmortal", 0, false, false, false),
                // STREAKS
                ("Trophy_streak_3", "En Racha", 100, true, false, false),
                ("Trophy_streak_5", "Imparable", 60, false, true, false),
                ("Trophy_streak_10", "Dominacion", 0, false, false, false),
                ("Trophy_streak_20", "Invencible", 0, false, false, true),
                // CASH BATTLE
                ("Trophy_cash_first", "Apostador", 100, true, false, false),
                ("Trophy_cash_first_win", "Ganador Real", 100, true, false, false),
                ("Trophy_cash_10_wins", "Jugador Serio", 50, false, true, false),
                ("Trophy_cash_50_wins", "High Roller", 20, false, true, false),
                ("Trophy_cash_100_wins", "Tiburon", 5, false, true, false),
                ("Trophy_cash_earnings_100", "Primeros $100", 35, false, true, false),
                ("Trophy_cash_earnings_1000", "Club de los Mil", 0, false, false, true),
                // TOURNAMENTS
                ("Trophy_tournament_first", "Participante", 100, true, false, false),
                ("Trophy_tournament_top3", "Podio", 0, false, false, false),
                ("Trophy_tournament_win", "Campeon", 0, false, false, false),
                ("Trophy_tournament_5_wins", "Multicampeon", 0, false, false, false),
                ("Trophy_tournament_create", "Organizador", 0, false, false, false),
                // SOCIAL
                ("Trophy_friend_first", "Primer Amigo", 100, true, false, false),
                ("Trophy_friends_10", "Popular", 70, false, true, false),
                ("Trophy_friends_50", "Influencer", 10, false, true, false),
                ("Trophy_challenge_friend", "Retador", 0, false, false, false),
                ("Trophy_beat_friend", "Rival", 0, false, false, false),
                // PROGRESSION
                ("Trophy_level_10", "Nivel 10", 100, true, false, false),
                ("Trophy_level_25", "Nivel 25", 60, false, true, false),
                ("Trophy_level_50", "Nivel 50", 30, false, true, false),
                ("Trophy_level_100", "Nivel 100", 0, false, false, false),
                // TIME
                ("Trophy_days_7", "Una Semana", 100, true, false, false),
                ("Trophy_days_30", "Un Mes", 50, false, true, false),
                ("Trophy_days_100", "100 Dias", 15, false, true, false),
                ("Trophy_days_365", "Un Ano", 0, false, false, true),
                ("Trophy_daily_streak_7", "Racha Semanal", 100, true, false, false),
                ("Trophy_daily_streak_30", "Racha Mensual", 25, false, true, false),
                // SECRET
                ("Trophy_night_owl", "Buho Nocturno", 0, false, false, true),
                ("Trophy_perfect_game", "Perfeccion", 0, false, false, true),
                ("Trophy_comeback_king", "Rey del Comeback", 0, false, false, true),
                ("Trophy_speed_demon", "Demonio de Velocidad", 0, false, false, true),
            };

...
namespace DigitPark.Editor
{
    ...
    /// Settings panel, countdown, feedback (Win/Lose panels now use global prefabs)
    /// </summary>
    public class OddOneOutUIBuilder : EditorWindow
    {
        ...
        private static void CreateHeader(Transform parent)
        {
            ...
            SetupText(title, "ODD ONE OUT", (int)FontSizes.H4, CYAN_NEON, FontStyles.Bold);
        }
        ...
        private static void CreateGridCell(Transform parent, int index, bool isRight)
        {
            ...
            TextMeshProUGUI tmp = SetupText(textObj, "A", (int)FontSizes.Subtitle, Color.white, FontStyles.Bold);
        ...
        private static void CreateSettingsPanel(Transform parent)
        {
            ...
            TextMeshProUGUI titleTmp = SetupText(titleObj, "ODD ONE OUT", (int)FontSizes.Subtitle, CYAN_NEON, FontStyles.Bold);
        ...
        private static void AssignControllerReferences()
        {
            ...
            // backButton and playAgainButton not used — Win/Lose panels now use global prefabs

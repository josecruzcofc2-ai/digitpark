...
namespace DigitPark.Editor
{
    ...
    public class NotificationsUIBuilder : EditorWindow
    {
        ...
        private static void CreateTab(Transform parent, string name, string label, Color accentColor, bool active)
        {
            ...
            tabBg.color = active ? new Color(0f, 1f, 1f, 0.12f) : new Color(0.15f, 0.17f, 0.22f, 0.5f);
        ...
        private static void CreateNotificationCardPrefab()
        {
            ...
            CreateActionButton(actionsRow.transform, "PrimaryButton", "Accept", CYAN_NEON, TEXT_DARK);

            // Secondary Action Button
            CreateActionButton(actionsRow.transform, "SecondaryButton", "Reject", CARD_BG, TEXT_SECONDARY);

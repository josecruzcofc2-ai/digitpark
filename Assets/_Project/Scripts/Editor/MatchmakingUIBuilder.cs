...
namespace DigitPark.Editor
{
    ...
    public class MatchmakingUIBuilder : EditorWindow
    {
        ...
        private static readonly Color CYAN_NEON = new Color(0f, 0.96f, 1f, 1f);              // #00F5FF
        ...
        private static void CreatePlayerCard(Transform parent, bool isPlayer)
        {
            ...
            Color accentColor = isPlayer ? CYAN_NEON : PURPLE_NEON;
            ...
            if (!isPlayer)
            {
                ...
                ringImg.color = new Color(PURPLE_NEON.r, PURPLE_NEON.g, PURPLE_NEON.b, 0.6f);

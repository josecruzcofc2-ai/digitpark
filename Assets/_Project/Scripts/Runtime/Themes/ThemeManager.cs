    ...
    public class ThemeManager : MonoBehaviour
    {
        ...
        public void SetTheme(ThemeData theme)
        {
            ...
            if (persistThemeChoice)
            {
                ...
                PlayerPrefs.Save();
                _ = SyncThemeToFirebase(theme.themeId);
            }
        }

        private async System.Threading.Tasks.Task SyncThemeToFirebase(string themeId)
        {
            try
            {
            ...
            {
                Debug.LogWarning($"[ThemeManager] Firebase sync failed: {e.Message}");
            }
        }

...
namespace DigitPark.Localization
{
    ...
    public class AutoLocalizer : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> TextNameToKeyMap = new Dictionary<string, string>
        {
            ...
            // ==================== CASHBATTLE HUB (V41) ====================
            { "CashEntryFeeLabel", "entry_fee" },
            { "CashAvailableBalanceText", "available_balance" },
            { "CashWeeklyLimitText", "weekly_limit" },
            { "CashCurrentStreakText", "current_streak" },
            { "CashBestStreakText", "best_streak" },
            { "CashRecordLabel", "record_label" },
            { "CashStatsByGameLabel", "stats_by_game" },
            { "CashFindOpponentText", "find_opponent" },
            { "CashConfirmButtonText", "confirm" },
            { "CashCloseButtonText", "close" },
            { "CashViewAllText", "view_all" },
            { "CashViewDetailsText", "view_details" },
            { "CashDepositButtonText", "deposit" },
            { "CashWithdrawButtonText", "withdraw" },
            { "CashGetPremiumText", "get_premium" },
            { "CashVictoryText", "victory" },
            { "CashDefeatText", "defeat" },
            { "CashSearchingText", "searching" },
            { "CashGetReadyText", "get_ready" },
            { "CashNoTournamentsText", "no_tournaments" },
            { "CashNoTransactionsText", "no_transactions" },

            // ==================== CASHBATTLE 1v1 (V41) ====================
            { "CashMaxLabel", "max_amount" },
            { "CashCustomPlaceholder", "custom_option" },
            { "CashOKButtonText", "ok_button" },
            { "CashPotentialEarningsText", "potential_earnings" },

            // ==================== CASH MATCHMAKING (V41) ====================
            { "CashMatchGameNameText", "game_name" },
            { "CashMatchEntryFeeText", "entry_fee" },
            { "CashMatchTitleText", "matchmaking_title" },
            { "CashMatchYouText", "you_label" },
            { "CashMatchVSText", "vs_label" },
            { "CashMatchStatusText", "searching" },
            { "CashMatchCancelText", "cancel" },

            // ==================== CASH TOURNAMENT LOBBY (V41) ====================
            { "CashTournSummaryLabel", "tournament_summary" },
            { "CashTournPrizeDistLabel", "prize_distribution" },
            { "CashTournTimeLeftText", "time_left" },
            { "CashTournPlayersText", "players_label" },
            { "CashTournLeaderboardText", "leaderboard" },
            { "CashTournChatPlaceholder", "chat_placeholder" },
            { "CashTournLeaveButtonText", "leave" },
            { "CashTournPlayButtonText", "play_button" },
            { "CashTournStartText", "tournament_starts" },
            { "CashTournAttemptsText", "attempts" },

            // ==================== CASH TOURNAMENT CREATE (V41) ====================
            { "CashTournNameLabel", "tournament_name" },
            { "CashTournGameLabel", "game_label" },
            { "CashTournEntryFeeLabel", "entry_fee" },
            { "CashTournPlayersLabel", "players_label" },
            { "CashTournDurationLabel", "duration_label" },
            { "CashTournCustomLabel", "custom_option" },
            { "CashTournCreateButtonText", "create_tournament" },
            ...
            // ==================== CASH BATTLE P3 (V42) ====================
            { "CashTournamentsEmptyText", "cash_no_tournaments" },

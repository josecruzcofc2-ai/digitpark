...
namespace DigitPark.Animations
{
    ...
    public class CountdownAnimator : MonoBehaviour
    {
        ...
        private void Setup()
        {
            ...
            countdownText.fontSizeMin = FontSizes.AutoMinTitle;
            countdownText.fontSizeMax = countdownText.fontSize;
        ...
        private IEnumerator CountdownSequence(Action onComplete)
        {
            ...
            canvasGroup.DOFade(0f, 0.2f).SetLink(gameObject).OnComplete(() =>
            {
                onComplete?.Invoke();
                Destroy(gameObject);
            });

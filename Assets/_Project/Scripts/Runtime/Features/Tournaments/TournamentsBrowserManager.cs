    ...
    public class TournamentsBrowserManager : MonoBehaviour
    {
        ...
        private List<TournamentData> GenerateMockTournaments()
        {
            ...
            for (int i = 0; i < tournamentsPerPage; i++)
            {
                ...
                {
                    name = AutoLocalizer.Get("tournament_name_default", currentPage * tournamentsPerPage + i + 1),
        ...
        private string GetEmptyStateMessage()
        {
            switch (currentTab)
            {
                ...
                case TournamentBrowserTab.Featured:
                    return AutoLocalizer.Get("tournament_empty_state_featured");
                default:
                    return AutoLocalizer.Get("tournament_empty_state_filtered");
            }
        }

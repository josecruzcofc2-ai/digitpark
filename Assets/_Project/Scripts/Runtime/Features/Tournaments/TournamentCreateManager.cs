...
namespace DigitPark.Managers
{
    ...
    public class TournamentCreateManager : MonoBehaviour
    {
        ...
        {
            if (titleText != null)
                titleText.text = AutoLocalizer.Get("create_tournament_title");
        ...
        private void StartCreation()
        {
            ...
            ShowStatus(AutoLocalizer.Get("tournament_creating"), false);
            UpdateCreateButtonState();
        ...
        private void ProcessCreation()
        {
            ...
            if (success)
            {
                ...
                ShowStatus(AutoLocalizer.Get("tournament_created_success"), false);

...
namespace DigitPark.CashBattle
{
    ...
    public class CashWalletSceneController : MonoBehaviour
    {
        ...
        private void RemoveButtonListeners()
        {
            ...
            if (depositTabButton) depositTabButton.onClick.RemoveAllListeners();
            if (withdrawTabButton) withdrawTabButton.onClick.RemoveAllListeners();
            if (historyTabButton) historyTabButton.onClick.RemoveAllListeners();
            if (closeDepositButton) closeDepositButton.onClick.RemoveAllListeners();
            if (closeWithdrawButton) closeWithdrawButton.onClick.RemoveAllListeners();
            if (withdrawButton) withdrawButton.onClick.RemoveAllListeners();
            if (loadMoreButton) loadMoreButton.onClick.RemoveAllListeners();
            if (paymentMethodButtons != null)
                foreach (var btn in paymentMethodButtons)
